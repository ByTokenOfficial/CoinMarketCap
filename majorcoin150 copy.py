...
if __name__ == '__main__':
    ...
    worksheet_new_on_list = googlesheet_handler.spreadsheet.worksheet(new_entry)
    ...
    for token in group4_slug_list:
        ...
        # 如果本來不在排行內，進到Group4當作移動1組
        elif token not in previous_major_list and token not in previous_group2_list and token not in previous_group3_list:
